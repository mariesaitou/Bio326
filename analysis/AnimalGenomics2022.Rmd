...
flowcellId     <- "FAK41706" # example  "FAK41706". Please adjust it according to your data.
basecaller     <-  "Guppy" # example "Guppy 2.1.3". Please adjust it according to your data.
```
